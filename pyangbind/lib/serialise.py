...
def make_generate_ietf_tree(yname_ns_func):
    ...
    def generate_ietf_tree(obj, parent_namespace=None, flt=False, with_defaults=None, add_empty_lists=False):
        ...
        if generated_by == "YANGListType":
        ...
        elif generated_by == "TypedListType":
            return [generate_ietf_tree(i, flt=flt, with_defaults=with_defaults) for i in obj]
            ...
            # were a scalar.
            return obj
        elif hasattr(obj, '_is_leaf'):
            if obj._is_leaf:
                return obj
        elif not hasattr(obj, '_pyangbind_elements'):
            return obj
